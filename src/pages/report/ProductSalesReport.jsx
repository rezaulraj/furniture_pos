  ...
  return (
    <div style={{ display: "flex", flexDirection: "column", gap: 20 }}>
      <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center" }}>
        <div>
          <h1 style={{ color: T.text, margin: 0 }}>Product-wise Sales</h1>
          <p style={{ color: T.textSub, margin: "5px 0 0" }}>Analyze sales performance by product</p>
        </div>
      ...
      <div style={{ ...card(), overflow: "hidden" }}>
        <table style={{ width: "100%", borderCollapse: "collapse" }}>
          <thead style={{ background: T.bg2 }}>
            <tr>
              {["Product Name", "SKU", "Qty Sold", "Total Amount"].map(h => (
          ...
          <tbody>
            {isLoading ? (
               ...
               <tr><td colSpan={4} style={{ padding: 40, textAlign: "center", color: T.textSub }}>No records found for this period</td></tr>
            ) : (
              data.map((item, i) => (
